...
// All configured accounts (tag + label) — used by the cross-account leaderboard,
// the one place that intentionally looks past a single account's own data.
export function listAccounts() {
  return getUsers().map(u => ({ tag: u.tag || u.username, label: u.label || u.username }));
}

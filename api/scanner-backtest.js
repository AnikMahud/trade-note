// Historical performance report for the dip-buy scanner: replays the exact
// same rules + exit logic as api/scanner.js and .github/scripts/notify.js
// day-by-day over real past prices, so "how many signals in the last N
// months, how many won/lost" can be answered without waiting for the live
// tracker to accumulate that history in real time.
...
// Per-day evaluation across the whole series (same rules as api/scanner.js's
// evaluate(), just computed at every index instead of only the latest one).
